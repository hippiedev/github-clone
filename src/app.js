...
let token = "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";
  ...
  .then((data) => {
    ...
    const html = data.data.user.repositories.nodes
      .map((repo) => {
        ...
        ${repo.forkCount == 0 ? '': `<span><svg aria-label="fork" role="img" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16" class="octicon octicon-repo-forked">
